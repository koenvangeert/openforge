...
export const ipcCommandContracts = [
  { functionName: 'createTask', ipcCommand: 'create_task', payloadKeys: ['initialPrompt', 'status', 'projectId', 'agent', 'permissionMode'], targetOwner: 'rust-sidecar', domain: 'tasks-projects' },
  ...
  { functionName: 'getAgents', ipcCommand: 'get_agents', payloadKeys: [], targetOwner: 'rust-sidecar', domain: 'misc' },
  ...
  { functionName: 'spawnPty', ipcCommand: 'pty_spawn', payloadKeys: ['taskId', 'serverPort', 'opencodeSessionId', 'cols', 'rows'], targetOwner: 'rust-sidecar', domain: 'agent-session-pty' },
